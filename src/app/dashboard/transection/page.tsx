        ...
        <div className="flex items-start justify-between">
          ...
          <div>
            <Link
              ...
              className={cn(buttonVariants({variant: 'outline'}), "text-xs md:text-sm mr-2")}
            >
              <IconMinus className="mr-2 h-4 w-4" /> Add Expense
            </Link>
            <Link
              href="/dashboard/transection/new"
              className={cn(buttonVariants(), "text-xs md:text-sm")}
            >
              <IconPlus className="mr-2 h-4 w-4" /> Add Income
            </Link>
          </div>
        </div>
        <Separator />
